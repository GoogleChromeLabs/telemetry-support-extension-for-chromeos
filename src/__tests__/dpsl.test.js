  ...
  const testCases = [
    {
      ...
      'method': dpsl.telemetry.getBacklightInfo,
    },
    {
      'name': 'getBatteryInfo',
      'method': dpsl.telemetry.getBatteryInfo,
    },
    {
      'name': 'getBluetoothInfo',
      'method': dpsl.telemetry.getBluetoothInfo,
    },
    {
      'name': 'getCpuInfo',
      'method': dpsl.telemetry.getCpuInfo,
    },
    {
      'name': 'getFanInfo',
      'method': dpsl.telemetry.getFanInfo,
    },
    {
      'name': 'getMemoryInfo',
      'method': dpsl.telemetry.getMemoryInfo,
    },
    {
      'name': 'getNonRemovableBlockDevicesInfo',
      'method': dpsl.telemetry.getNonRemovableBlockDevicesInfo,
    },
    {
      'name': 'getStatefulPartitionInfo',
      'method': dpsl.telemetry.getStatefulPartitionInfo,
    },
    {
      'name': 'getTimezoneInfo',
      'method': dpsl.telemetry.getTimezoneInfo,
    },
  ];
  testCases.forEach((testCase) => {
    test(`dpsl.telemetry.${testCase.name} throws an exception`, (done) => {
      testCase.method().catch((error) => {
