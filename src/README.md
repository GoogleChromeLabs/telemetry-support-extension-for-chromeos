...
[comment]: <Contents below is manually generated from the source code.>
Contents
========
- [NOTES](#notes)
- [Contents](#contents)
...
- [API Summary](#api-summary)
  - [Types](#types)
    ...
    - [Routine](#routine)
      - [Important Notes regarding routine's id](#important-notes-regarding-routines-id)
    - [AudioInfo](#audioinfo)
    - [AudioOutputNodeInfo](#audiooutputnodeinfo)
    - [AudioInputNodeInfo](#audioinputnodeinfo)
    - [VpdInfo](#vpdinfo)
    - [OemDataInfo](#oemdatainfo)
    - [CpuInfo](#cpuinfo)
    - [PhyiscalCpuInfo](#phyiscalcpuinfo)
    ...
    - [AcPowerRoutineParams](#acpowerroutineparams)
    - [BatteryDischargeRoutineParams](#batterydischargeroutineparams)
    - [BatteryChargeRoutineParams](#batterychargeroutineparams)
    - [CpuRoutineDurationParams](#cpuroutinedurationparams)
    - [NvmeWearLevelRoutineParams](#nvmewearlevelroutineparams)
    - [NvmeSelfTestRoutineParams](#nvmeselftestroutineparams)
    - [SmartctlCheckRoutineParams](#smartctlcheckroutineparams)
    - [PowerButtonRoutineParams](#powerbuttonroutineparams)
    - [BluetoothScanningRoutineParams](#bluetoothscanningroutineparams)
    - [BluetoothPairingRoutineParams](#bluetoothpairingroutineparams)
    - [UsbBusInterfaceInfo](#usbbusinterfaceinfo)
    - [Enum FwupdVersionFormat](#enum-fwupdversionformat)
    - [FwupdFirmwareVersionInfo](#fwupdfirmwareversioninfo)
    - [Enum UsbVersion](#enum-usbversion)
    - [Enum UsbSpecSpeed](#enum-usbspecspeed)
    - [UsbBusInfo](#usbbusinfo)
    - [UsbDevicesInfo](#usbdevicesinfo)
    - [Enum DisplayInputType](#enum-displayinputtype)
    - [EmbeddedDisplayInfo](#embeddeddisplayinfo)
    - [ExternalDisplayInfo](#externaldisplayinfo)
    - [DisplayInfo](#displayinfo)
  - [Functions](#functions)
    - [dpsl.telemetry.\*](#dpsltelemetry)
    - [dpsl.diagnostics.\*](#dpsldiagnostics)
    - [dpsl.diagnostics.power.\*](#dpsldiagnosticspower)
    - [dpsl.diagnostics.battery.\*](#dpsldiagnosticsbattery)
    - [dpsl.diagnostics.cpu.\*](#dpsldiagnosticscpu)
    - [dpsl.diagnostics.memory.\*](#dpsldiagnosticsmemory)
    - [dpsl.diagnostics.disk.\*](#dpsldiagnosticsdisk)
    - [dpsl.diagnostics.emmc.\*](#dpsldiagnosticsemmc)
    - [dpsl.diagnostics.nvme.\*](#dpsldiagnosticsnvme)
    - [dpsl.diagnostics.ufs.\*](#dpsldiagnosticsufs)
    - [dpsl.diagnostics.network.\*](#dpsldiagnosticsnetwork)
    - [dpsl.diagnostics.sensor.\*](#dpsldiagnosticssensor)
    - [dpsl.diagnostics.audio.\*](#dpsldiagnosticsaudio)
    - [dpsl.diagnostics.hardwareButton.\*](#dpsldiagnosticshardwarebutton)
    - [dpsl.diagnostics.bluetooth.\*](#dpsldiagnosticsbluetooth)
    - [dpsl.diagnostics.fan.\*](#dpsldiagnosticsfan)
  - [Status codes \& messages](#status-codes--messages)
    - [Shared status codes](#shared-status-codes)
    - [List of status codes by routine](#list-of-status-codes-by-routine)
      ...
      - [Fan](#fan)
      - [Fingerprint Alive](#fingerprint-alive)
      ...
      - [DNS Resolver Present](#dns-resolver-present)
      - [Gateway can be Pinged](#gateway-can-be-pinged)
      - [LAN Connectivity](#lan-connectivity)
      - [Signal Strength](#signal-strength)
      - [Sensitive Sensor](#sensitive-sensor)
      - [Disk Read](#disk-read)
      - [Emmc Lifetime](#emmc-lifetime)
      - [NVMe Self Test](#nvme-self-test)
      - [NVMe Wear Level](#nvme-wear-level)
      - [Prime Search](#prime-search)
      - [Smartctl Check](#smartctl-check)
      - [UFS Life Time](#ufs-life-time)
